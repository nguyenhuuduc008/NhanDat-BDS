    ...
    function config($stateProvider) {
        $stateProvider.state(
         ...
         .state('loaiNoiThat-list', {
             ...
             parent: 'root',
             url: '/setting/khoanGia',
             templateUrl: 'app/setting/khoanGia/list.tpl.html',
             controller: 'listCtr',
             controllerAs: 'listVm',
             data: {
                 pageTitle: 'Quản lý Khoản giá',
                 module: 'setting',
                 icon: 'icon-settings',
                 parent: 'settingList'
             },
         ...
         }).state('khoanGia.chiTiet', {
                parent: 'root',
                url: '/setting/khoanGia/chiTiet/:id',
                templateUrl: 'app/setting/khoanGia/chiTiet.tpl.html',
                controller: 'chiTietCtr',
                controllerAs: 'chiTietVm',
                data: {
                    pageTitle: '',
                    module: 'setting',
                    parent: 'settingList',
