(function () {
	...
	angular.module("app.bds").factory("lichSuGiaoDichService", lichSuGiaoDichService);
	/** @ngInject **/
	function lichSuGiaoDichService($q, $filter, $firebaseObject, $firebaseArray, firebaseDataRef, appUtils) {
		var rootPath = 'bds-lich-su-giao-dich', tacNghiepRef = firebaseDataRef.child(rootPath);
		var lichSuGiaoDichService = {
			get: get,
			getAll: getAll,
			create: create,
			update: update,
