(function () {
	...
	angular.module("app.bds").factory("lichSuChuyenQuyenService", lichSuChuyenQuyenService);
	/** @ngInject **/
	function lichSuChuyenQuyenService($q, $filter, $firebaseObject, $firebaseArray, firebaseDataRef, appUtils) {
		var rootPath = 'bds-lich-su-chuyen-quyen', tacNghiepRef = firebaseDataRef.child(rootPath);
		var lichSuChuyenQuyenService = {
			get: get,
			getAll: getAll,
			create: create,
			update: update,
		...
		return lichSuChuyenQuyenService;
