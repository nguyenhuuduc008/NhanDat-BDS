(function () {
	...
	angular.module("app.bds").factory("lichSuGia", lichSuGia);
	/** @ngInject **/
	function lichSuGia($q, $filter, $firebaseObject, $firebaseArray, firebaseDataRef, appUtils) {
		var rootPath = 'bds-lich-su-gia', tacNghiepRef = firebaseDataRef.child(rootPath);
		var lichSuGia = {
			get: get,
			getAll: getAll,
			create: create,
