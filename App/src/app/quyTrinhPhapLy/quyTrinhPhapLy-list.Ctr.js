(function(){
    ...
    function quyTrinhPhapLyListCtr($rootScope, $scope, $state,$q,quyTrinhPhapLyService,appUtils,$ngBootbox,toaster){
        ...
        quyTrinhPhapLyListVm.selectAction = 'Bulk Actions';
        ...
        quyTrinhPhapLyListVm.apply = function(chkName){
            ...
            var removeIndex = quyTrinhPhapLyListVm.selectAction.indexOf('Delete');
            if(removeIndex === -1){
            ...
            $ngBootbox.confirm('Are you sure want to apply ' + quyTrinhPhapLyListVm.selectAction + ' action as selected?')
            .then(function() {
                var removePromise=[];
